    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if(args.Contains("--autogame"))
            {
                ...
                Block startBlock = new Block(new GameText("", "You are in the first room. What do you do?", ""));
                Block optionA = new Block(new GameText("Choose ", "Option A", " Was the best option."));
                Block optionB = new Block(new GameText("Choose ", "Option B", " Gives a sub-option!"));
                Block optionB1 = new Block(new GameText("Choose ", "Option B1", " was bad. Tough luck!"));
